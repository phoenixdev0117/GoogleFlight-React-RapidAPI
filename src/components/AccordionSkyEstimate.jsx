...
export default function AccordionSkyEstimate({ flue }) {
  ...
  return (
      ...
      <ul className='w-[240px] row-span-3'>
        ...
        <li className="flex text-[12px] opacity-70 gap-2 mb-1">
          <div className='w-[14px] h-[14px]'><svg focusable="false" width="16" height="16" viewBox="0 0 24 24" className="qqxCKc NMm5M" aria-hidden="true"><path d="M16 9v4.66l-3.5 3.51V19h-1v-1.83L8 13.65V9h8m0-6h-2v4h-4V3H8v4h-.01C6.9 6.99 6 7.89 6 8.98v5.52L9.5 18v3h5v-3l3.5-3.51V9c0-1.1-.9-2-2-2V3z"></path></svg></div>
          In-seat power &amp; USB outlets
        </li>
        <li className="flex text-[12px] opacity-70 gap-2 mb-1">
          <div className='w-[14px] h-[14px]'><svg focusable="false" width="16" height="16" viewBox="0 0 24 24" className="qqxCKc NMm5M" aria-hidden="true"><path d="M9 7v8l7-4z"></path><path d="M21 3H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h5v2h8v-2h5c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 14H3V5h18v12z"></path></svg></div>
          On-demand video
        </li>
        <li className="flex text-[12px] opacity-70 gap-2 mb-1">
          ...
          <div className="h6GTp">
            <span className="gI4d6d" aria-label="Carbon emissions estimate: 4,231 kilograms">
              Emissions estimate: {flue} kg CO2e
            </span>
          </div>
        </li>
      </ul>
